...
class playGame extends Phaser.Scene{
    ...
    create(){
		...
		this.waterMelon = this.add.sprite(game.config.width - 35, 35, "furits");
		this.waterMelon.setFrame(11);
        this.waterMelon.setScale(0.30);
    ...
    setFurit(){
        ...
        this.playerFruit.setFrame(Phaser.Math.Between(0, gameOptions.playerFruitsRange));
